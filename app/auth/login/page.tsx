        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="hidden lg:block">
            ...
            <h1 className="mt-8 text-4xl font-semibold tracking-tight text-foreground">
              Log in and start the hunt.
            </h1>
            <p className="mt-3 text-sm text-muted-foreground max-w-md leading-relaxed">
              Find opportunities, generate high-quality creatives, and organize everything into campaigns—built for ad arbitrage workflows.
            </p>
            ...
            <div className="mt-8 grid gap-3 max-w-md">
              <div className="flex items-start gap-3 rounded-2xl border border-border bg-card/50 backdrop-blur p-4">
                ...
                <div>
                  <div className="text-sm font-semibold text-foreground">Fast workflows</div>
                  <div className="text-xs text-muted-foreground mt-1">Discovery → Creative Studio → Campaigns, end-to-end.</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 rounded-2xl border border-border bg-card/50 backdrop-blur p-4">
                ...
                <div>
                  <div className="text-sm font-semibold text-foreground">Better creatives</div>
                  <div className="text-xs text-muted-foreground mt-1">A/B variations with brand- and intent-aware prompting.</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 rounded-2xl border border-border bg-card/50 backdrop-blur p-4">
                ...
                <div>
                  <div className="text-sm font-semibold text-foreground">Secure by default</div>
                  <div className="text-xs text-muted-foreground mt-1">Hard-gated access and user-scoped data.</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <Card className="w-full max-w-md p-6 sm:p-8 bg-card/70 border-border backdrop-blur">
              <div className="space-y-2 mb-6">
                ...
                <p className="text-sm text-muted-foreground">Use your email + password to access the dashboard.</p>
              </div>
